...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class LoggingLibraryAccessors extends SubDependencyFactory {
        private final LoggingInterceptorLibraryAccessors laccForLoggingInterceptorLibraryAccessors = new LoggingInterceptorLibraryAccessors(owner);

        public LoggingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>logging.interceptor</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public LoggingInterceptorLibraryAccessors getInterceptor() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForLoggingInterceptorLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class LoggingInterceptorLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public LoggingInterceptorLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>v492</b> with <b>com.squareup.okhttp3:logging-interceptor</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV492() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("logging.interceptor.v492");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>activityKtx</b> with value <b>1.10.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
